...
function EmployeesAttendanceReport() {
  ...
  const fetchReport = async () => {
    setLoading(true);
    try {
      const res = await api.get("/attendance/employee-report", {
        params: { from, to },
      });
      setRows(res.data || []);
    } catch (err) {
  ...
  const handleCSV = () => {
    ...
    downloadFile(lines.join("\n"), "employee-attendance-report.csv", "text/csv");
  };
    ...
    <div className="report-shell">
      <div className="card">
        <div className="report-header">
          <h3>Employees Attendance Report</h3>
...
export default EmployeesAttendanceReport;
